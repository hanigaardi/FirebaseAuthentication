                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (!task.isSuccessful()){
                            snacbar = Snackbar.make(activity_sign_up, "Error: "+task.getException(),Snackbar.LENGTH_SHORT);
                            snacbar.show();
                        }else {
                            snacbar = Snackbar.make(activity_sign_up, "Register success: ",Snackbar.LENGTH_SHORT);
                            snacbar.show();
                        }
                    }
                });
